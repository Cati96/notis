...
public class NotaryController {
    ...
    @GetMapping(value = "{country}/{county}/{city}")
    public List<Notary> getAllNotariesForAddress(@RequestParam("country") String country,
												 @RequestParam("county") String county,
												 @RequestParam("city") String city) {
        return notaryService.getAllByAddress(country, county, city);
    }
